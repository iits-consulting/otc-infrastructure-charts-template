...
|------|----------|-------------|-------------|
| portal | KumoOps | `https://iits-consulting.portal.kumo-ops.com/` | Main KumoOps portal dashboard |
| support | KumoOps | `support@kumo-ops.com` | KumoOps Support |
| shop | KumoOps Portal | `https://start.kumo-ops.com` | KumoOps Shop |
| docs | KumoOps | `https://admin.{{.Values.projectValues.stageDomain}}/docs/` | Technical documentation |
...
See [VALIDATION.md](VALIDATION.md) for schema validation, template validation, and troubleshooting.
